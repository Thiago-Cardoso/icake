<?php
/**
 * Configurações para a aplicação icake.
 *
 ...
 * Nome do Sistema
 */
Configure::write('SISTEMA','iCake');

/**
 * Nome da Empresa
 */
Configure::write('EMPRESA','Viva o GNU/Linux e o MIT/cakePHP');

/**
 * Sigla da Empresa
 */
Configure::write('SIGLA','iCake');
 ...
 */	Configure::write('Security.salt', '90c09cb2a20a88c0758006bf6a7f94fc1e4cf854');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */	Configure::write('Security.cipherSeed', '333139306266663138633834313234');
