...
<p class='sql_obs2'>* Para alterar as configurações do banco de dados, edite o arquivo app/config/database.php</p>
<p class='sql_obs3'>Cliquei <a href="<?php echo $this->here; ?>">aqui</a> para atualizar.</p>
</div>

<?php $this->Visao->setOnReadView('$("#instala").css("display","none");'); ?>
